...
<div class="row">
    <div class="col-md-12">
        <div class="row-top mt-3 mb-3 d-flex justify-content-between align-items-center">
            <h1 class="">Lists content projects</h1>
                    ...
                    <div class="modal-body">
                        <form action="" method="post" id="form">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" id="date-start" class="form-control" name="time_start" placeholder="Date...">
                            </div>
                            <div class="form-group mt-3">
                                <label for="" class="form-label">Time completed:</label>
                                <input type="text" id="date-end" class="form-control" name="time_completed" placeholder="Date...">
                            </div>
